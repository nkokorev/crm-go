...
func (DeliveryCourier) getListByShop(accountId, websiteId uint) ([]DeliveryCourier, error) {
	...
	err := (&DeliveryCourier{}).GetPreloadDb(false, false, []string{"PaymentMethods"}).
...
func (deliveryCourier DeliveryCourier) CreateDeliveryOrder(deliveryData DeliveryData, cost float64, order Order) (Entity, error)  {
