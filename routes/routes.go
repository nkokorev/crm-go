...
*/
	...
	rAppAuthUser.Use(middleware.CorsAccessControl,	middleware.CheckAppUiApiStatus, middleware.ContextMainAccount, middleware.JwtUserAuthentication)
	rAppAuthFull.Use(middleware.CorsAccessControl,	middleware.CheckAppUiApiStatus,	middleware.ContextMainAccount, 	middleware.JwtFullAuthentication)
